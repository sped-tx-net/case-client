// -----------------------------------------------------------------------
// <copyright file="Configuration.cs" company="sped-tx.net">
...
namespace Ims.Case.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        /// <summary>
        /// Defines the GlobalConfigSync.
        /// </summary>
        private static readonly object GlobalConfigSync = new { };
        /// <summary>
        /// Defines the _globalConfiguration.
        /// </summary>
        ...
        public Configuration()
        {
            ...
            BasePath = "https://teks-api.texasgateway.org/ims/case/v1p0";
        ...
        /// Initializes a new instance of the <see cref="Configuration"/> class.
        /// </summary>
        /// <param name="defaultHeader">The defaultHeader<see cref="IDictionary{string, string}"/>.</param>
        /// <param name="apiKey">The apiKey<see cref="IDictionary{string, string}"/>.</param>
        /// <param name="apiKeyPrefix">The apiKeyPrefix<see cref="IDictionary{string, string}"/>.</param>
        /// <param name="basePath">The basePath<see cref="string"/>.</param>
        public Configuration(
            IDictionary<string, string> defaultHeader,
            IDictionary<string, string> apiKey,
            IDictionary<string, string> apiKeyPrefix,
            string basePath = "https://teks-api.texasgateway.org/ims/case/v1p0") : this()
        {
