...
namespace Ims.Case.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CFSubject : IEquatable<CFSubject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CFSubject"/> class.
        /// </summary>
        ...
        public CFSubject(string identifier = default(string), string uri = default(string), string title = default(string), string hierarchyCode = default(string), string description = default(string), DateTime? lastChangeDateTime = default(DateTime?))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for CFSubject and cannot be null");
            }
            else
            {
            ...
            if (uri == null)
            {
                throw new InvalidDataException("uri is a required property for CFSubject and cannot be null");
            }
            else
            {
                Uri = uri;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for CFSubject and cannot be null");
            }
            else
            {
                Title = title;
            ...
            {
                throw new InvalidDataException("hierarchyCode is a required property for CFSubject and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("lastChangeDateTime is a required property for CFSubject and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Returns true if CFSubject instances are equal.
        /// </summary>
        /// <param name="input">Instance of CFSubject to be compared.</param>
        /// <returns>Boolean.</returns>
        public bool Equals(CFSubject input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as CFSubject);
        }
